...
const FarmerUpload: React.FC = () => {
  ...
  return (
    <div className="flex w-full px-6 md:w-[95%] mx-auto min-h-screen font-dm-sans">
      <div className="mt-12 ">
        ...
        <form className="space-y-6 mx-auto w-full">
          {/* Produce Name */}
          <div>
        ...
        <div className="mt-24 border-t-2 border-black/40 pt-4 hidden md:block w-[80%] md:w-full">
        ...
        {/* MOBILE TABLE */}
        <div className="mt-24 border-t-2 md:hidden border-black/40 w-full">
          <h2 className="text-2xl font-bold mb-6">Uploaded Produce</h2>
          <div className="overflow-x-auto">
            <table className="w-full table-auto border-collapse text-sm">
              <thead>
