...
const Sidebar = ({ open, onClose }: Props) => {
  ...
  const navigate = useNavigate()
    ...
    const handleLogout = () => {
    logout(); // clears all context + localStorage
          ...
          <div className="pl-4 h-full w-full text-sm pt-1 pb-5 bg-[#f5f5f5]">
            ...
            <div className="mt-10 pl-3">
              <div className="flex items-center gap-3">
                ...
                <button className="mt-4 flex items-center ml-4 font-semibold gap-2 cursor-pointer text-black" onClick={handleLogout}>
            ...
            <div className="pl-4 py-3 w-full bg-[#f5f5f5]">
              ...
              <div className="mt-auto pl-3 py-15">
                <div className="flex items-center gap-3">
                  ...
                  <button className="mt-4 flex items-center ml-4 font-semibold text-lg gap-2 cursor-pointer text-black" onClick={handleLogout}>
                    <LogOut className="w-4 h-4 font-bold" /> Logout
                  </button>
